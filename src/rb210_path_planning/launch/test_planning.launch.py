...
def launch_setup(context, *args, **kwargs):
    ...
    move_group_params = {
        ...
        "use_fake_hardware": use_fake_hardware.lower() == "true"
    }
    ...
    path_planning_client = Node(
        package=planning_pkg,
        executable="path_planning_client",
        name="path_planning_client",
        output="screen",
        parameters=[{"use_fake_hardware": use_fake_hardware}]
    )

    sim_visual_node = Node(
        package=planning_pkg,
        executable="sim_visual_detection_node",
        name="sim_visual_detection_node",
        output="screen"
    )
